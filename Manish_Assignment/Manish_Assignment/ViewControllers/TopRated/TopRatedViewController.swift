...
class TopRatedViewController: BaseViewController {
    ...
    lazy var viewModel : TopRatedViewModel = {
        let viewModel = TopRatedViewModel(dataSource: dataSource, controller: self)
        return viewModel
    }()
    ...
    override func viewDidLoad() {
        ...
        self.viewModel.getTopRatedData()
...
extension TopRatedViewController: MovieCollectionViewCellDelegate {
