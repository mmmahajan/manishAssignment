...
class TabNavigationMenu: UIView {
    ...
    convenience init(menuItems: [TabItem], frame: CGRect) {
        ...
        self.layer.backgroundColor = UIColor.FlatColor.PrimaryColor.cgColor
        
        for i in 0 ..< menuItems.count {
            let itemWidth = self.frame.width / CGFloat(menuItems.count)
            let leadingAnchor = (itemWidth * CGFloat(i)) + itemWidth/4
    ...
    func createTabItem(item: TabItem) -> UIView {
        ...
        tabBarItem.layer.backgroundColor = UIColor.FlatColor.PrimaryColor.cgColor
        ...
        NSLayoutConstraint.activate([
            ...
            itemTitleLabel.heightAnchor.constraint(equalToConstant: 15), // Fixed height for title label
